...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('penyewaan', function (Blueprint $table) {
            $table->integer('penyewaan_id')->primary()->nullable(false)->auto_increment();
            $table->integer('penyewaan_pelanggan_id')->nullable(false);
            $table->timestamp('penyewaan_tglsewa')->nullable(false);
            $table->timestamp('penyewaan_tglkembali')->nullable(false);
            ...
            $table->foreign('penyewaan_pelanggan_id')->references('pelanggan_id')->on
            ('pelanggan')->onDelete('cascade')->onUpdate('cascade');
        });
    }
