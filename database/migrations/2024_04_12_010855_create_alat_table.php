...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('alat', function (Blueprint $table) {
            $table->integer('alat_id')->primary()->nullable(false)->auto_increment();
            ...
            $table->foreign('alat_kategori_id')->references('kategori_id')->on
            ('kategori')->onDelete('cascade')->onUpdate('cascade');
        });
    }
