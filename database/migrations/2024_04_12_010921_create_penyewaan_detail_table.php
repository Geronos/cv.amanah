...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('penyewaan_detail', function (Blueprint $table) {
            $table->integer('penyewaan_detail_id')->primary()->nullable(false)->auto_increment();
            ...
            $table->foreign('penyewaan_detail_penyewaan_id')->references('penyewaan_id')->on
            ('penyewaan')->onDelete('cascade')->onUpdate('cascade');

            $table->foreign('penyewaan_detail_alat_id')->references('alat_id')->on
            ('alat')->onDelete('cascade')->onUpdate('cascade');
        });
    }
